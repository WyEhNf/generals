...
& $python scripts\train_bc.py `
    ...
    --device cuda `
    --amp `
    --resume-from artifacts\phase1\temporal_k8_v2_long20000.pt `
    --output artifacts\phase1\temporal_k8_v2_long50000.pt `
    --metrics-output artifacts\phase1\temporal_k8_v2_long50000.metrics.jsonl

if ($LASTEXITCODE -ne 0) {
    throw "K=8 long50k failed with exit code $LASTEXITCODE"
}
