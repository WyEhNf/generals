...
& $python scripts\train_bc.py `
    ...
    --device cuda `
    --amp `
    --resume-from artifacts\phase1\temporal_k8_v2_screen1000.pt `
    --output artifacts\phase1\temporal_k8_v2_long20000.pt `
    --metrics-output artifacts\phase1\temporal_k8_v2_long20000.metrics.jsonl

if ($LASTEXITCODE -ne 0) {
    throw "K=8 long20k failed with exit code $LASTEXITCODE"
}
